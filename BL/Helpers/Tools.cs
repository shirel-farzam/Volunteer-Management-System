        ...
        public static int TotalHandledCalls(int Id)
        {
            ...
            return _dal.Assignment.ReadAll()
                .Count(a => a.VolunteerId == Id &&
                            a.TimeEnd == AssignmentCompletionType.);     

        }
        public static int TotalCallsCancelledhelp(int Id)
        {
            // Count how many assignments were cancelled by admin
            return _dal.Assignment.ReadAll()
                .Count(a => a.VolunteerId == Id &&
                            (a.TimeEnd == AssignmentCompletionType.AdminCancelled || a.TimeEnd == AssignmentCompletionType.Canceled));
        }
